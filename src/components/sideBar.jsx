	...
	if(props.hide)
		...
		return (
			...
			<div>
				...
				<NavLink key={5} className={styles.sideitem} onClick={showSidebar} to="/about">
					<span><BiSupport /></span>
					<span className={styles.linkText}>Support {sidebar?<RiArrowUpSFill /> :<RiArrowDownSFill />}</span>
				</NavLink>
